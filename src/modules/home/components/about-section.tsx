    ...
    <div className="container mx-auto grid max-w-6xl grid-cols-1 gap-12 px-6 md:grid-cols-2 items-center">
      ...
      <div className="flex flex-col justify-center">
        ...
        <SlideInOnScroll direction='up' duration={1100}>
          <Button
            asChild
            className="text-base md:text-lg font-semibold rounded-full bg-[var(--color-brand)] text-[var(--color-brand-foreground)] hover:bg-[var(--color-brand)]/90 px-6 py-5 md:px-8 md:py-6 self-start"
          >
