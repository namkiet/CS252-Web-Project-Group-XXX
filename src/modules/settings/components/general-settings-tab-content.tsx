        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <Label className="text-orange-700">Theme</Label>
              <DropdownMenu>
            ...
            {/* Language Setting */}
            <div className="space-y-2">
              <Label className="text-orange-700">Language</Label>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" className="w-full justify-between border-gray-300 bg-white text-gray-900 shadow-none hover:bg-orange-50">
                    <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <Label className="text-orange-700">Message Notifications</Label>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <Label className="text-orange-700">Sound Effects</Label>
                <p className="text-sm text-muted-foreground">
